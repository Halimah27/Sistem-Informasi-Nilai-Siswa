...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?page=utama">SISTEM INFORMASI NILAI SISWA SD XYZ</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="?page=nilai&actions=tampil">Nilai Siswa</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?page=datasiswa&actions=report">Laporan Data Siswa</a></li>
                                    <li><a href="?page=nilai&actions=report">Laporan Nilai Siswa</a></li>
                    </ul>
                </li>
